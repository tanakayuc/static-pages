...
const contentChecks = [
  ...
  ["roadmap.html", "個別説明会パターン"],
  ["roadmap.html", "セミナーからの個別説明会パターン"],
  ["roadmap.html", "セミナーでの直接販売パターン"],
  ["roadmap.html", "セールスレター（販売ページ）による直接販売パターン"],
  ["roadmap.html", "KPI仮設定"],
  ...
  ["visual-report.html", "個別説明会パターン"],
  ["visual-report.html", "セミナーからの個別説明会パターン"],
  ["visual-report.html", "セミナーでの直接販売パターン"],
  ["visual-report.html", "セールスレター（販売ページ）による直接販売パターン"],
