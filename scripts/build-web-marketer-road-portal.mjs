...
const productionLayerRows = [
  {
    ...
    items: [
      ...
      ["オプトイン後メルマガ", "登録直後から正式参加・Day1着席へ戻すメールを作る。", "stepmail.html"],
      ["サンキューページ原稿", "登録直後ページで、LINEオープンチャット参加へ進める本文を作る。", "thank-you-copy.html"],
      ["集客前メッセージ", "全体素材が揃った後、ハウスリストや紹介元へ送る集客前メルマガを作る。", "stepmail.html"],
    ],
  },
  {
    layer: "価値提供フェーズの素材",
...
const productionCategoryRows = [
  {
    ...
    meta: "Traffic",
    href: "lp.html",
    detail: "登録前から正式参加・Day1着席まで。LP、ヘッド指示、VSL、オプトイン後メルマガ、サンキューページ、集客前メッセージを確認します。",
    items: ["オプトインLP原稿", "LPヘッドデザイン指示書", "オプト前VSL台本", "集客前メッセージ"],
  },
  {
    label: "価値提供の素材一覧",
    meta: "Value",
...
const acquisitionMaterialRows = [
  ["オプトインLP原稿", "登録前", "誰に、何を約束し、なぜ今参加するのかをLP本文として作る。", "optin-lp-copy.html", `${materialMdRoot}/01_集客素材/01_オプトインLP原稿/`],
  ["LPヘッドデザイン指示書", "ファーストビュー", "ヘッドのコピー、画像方向、CTA、参考サンプル、スマホ表示の指示をセットで作る。", "head.html", `${materialMdRoot}/01_集客素材/02_LPヘッドデザイン指示書/`],
  ["オプト前VSL台本", "登録前VSL", "LP上で登録前の教育と選別を行う動画台本を作る。", "script-opening.html", `${materialMdRoot}/01_集客素材/03_オプト前VSL台本/`],
  ["オプトイン後メルマガ", "登録直後", "登録直後〜1時間後に、正式参加・Day1着席へ戻すメールを作る。", "stepmail.html", `${materialMdRoot}/01_集客素材/04_オプトイン後メルマガ/`],
  ["サンキューページ原稿", "登録直後", "メール登録で止めず、LINEオープンチャット参加へ進めるページ本文を作る。", "thank-you-copy.html", `${materialMdRoot}/01_集客素材/05_サンキューページ原稿/`],
  ["集客前メッセージ", "集客開始前", "ハウスリスト、紹介元、自社メルマガから登録ページへ送る集客前メッセージを作る。", "stepmail.html", `${materialMdRoot}/01_集客素材/07_集客前メッセージ/`],
];
...
function parseMail(relative) {
  ...
  const phase = relative.includes("フェーズ0") ? "集客前" : relative.includes("フェーズ1") ? "登録後" : isLine ? "公式LINE" : "販売期";
...
<div class="format-stages">
  <section class="format-stage">
    ...
    <p>今回の集客素材は${esc(media.label)}、オプトインLP原稿、LPヘッドデザイン指示書、VSL台本、オプトイン後メルマガ、サンキューページ原稿です。</p>
  </section>
  <section class="format-stage">
...
const setupMails = list("12_メルマガ/フェーズ0_セットアップ/アフィリエイト紹介文").map(parseMail);
...
<tr><td>集客</td><td>オプトインLP原稿、LPヘッドデザイン指示書、オプト前VSL台本、オプトイン後メルマガ、サンキューページ原稿、集客前メッセージ</td><td><a href="lp.html">集客素材</a></td></tr>
