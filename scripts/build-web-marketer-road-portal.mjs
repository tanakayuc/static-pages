...
const productionFlowRows = [
  ...
  {
    phase: "2. リサーチ/コンセプト",
    purpose: "ターゲット、競合、プロダクトホルダーが提供できる価値をつなぎ、空きポジションと採用コンセプトを決める。",
...
const researchFlowRows = [
  ...
  ["7. プロダクトホルダー価値", "プロダクトホルダー、コンテンツホルダーが提供できる実績、思想、商品、文化、サポートを棚卸しする。", "提供価値リスト"],
  ["8. USP判定", "その価値がユニークベネフィットなのか、アドバンテージなのかを判定し、伝わる切り口へ変換する。", "USP判定"],
...
const researchPrincipleRows = [
  ...
  ["USPは2種類で判定する", "他より良いアドバンテージUSPなのか、別の欲求を満たすユニークベネフィットUSPなのかを分ける。自社サイトやチャレンジ導線では、私のためだと伝わる切り口を優先する。"],
  ["接点から言葉を作る", "プロダクトホルダー側の独自性をそのまま出すのではなく、見込み客の状況と商品の価値が交わる接点を一文にする。"],
];
...
const researchCutRows = [
  ...
  ["プロダクトホルダーならどうずらすか", "コンテンツホルダーが提供できる価値を、見込み客の状況に合わせて別の切り口へ変換する。"],
];
...
const positioningLogicRows = [
  ...
  ["プロダクトホルダーが提供できる価値", "コンテンツホルダーの実績、思想、商品、サポート、環境、文化を、ついていけない人の状況に接続する。"],
  ["USP判定", "競合より優れているアドバンテージUSPなのか、別の欲求に刺さるユニークベネフィットUSPなのかを判定する。"],
  ["訴求表現", "空きポジションを一文で言えるようにし、LP、動画、ステップメール、セールスレターへ展開する。"],
];

const competitorPositionRows = [
  ["YCS 横山直宏さん", "自分らしさ、共感、経営者コミュニティ、ファンマーケティング。", "経営者本人の価値観や発信を前に出すことが重く見える人。", "裏方で関わる、既存の価値を売れる形にする、チームの一員として支える道を探す。", "プロダクトローンチの現場経験、全員で勝つ文化、裏方人材が機能する実践環境。", "ユニークベネフィット", "自分らしく発信できなくても、社長の右腕として売上を支える道がある。"],
  ["YouTubeマーケターおさるさん", "SNS動画、コンテンツ販売、高い実績、スピード感。", "個人発信力、スター性、SNSで伸ばす前提についていけない人。", "発信者になるより、売れる仕組みを理解し、プロモーションの裏側を担う道を探す。", "ファネル全体を分解し、LP、配信、台本、レターまで制作物として見せられること。", "ユニークベネフィット", "目立つ人にならなくても、売れる仕組みを支えるWebマーケターになれる。"],
  ["仙道達也さん", "魂の差別化、個人起業家のコンセプト作り、伴走支援。", "自分の商品や強い内的テーマがないため、商品作りから始めることに抵抗がある人。", "自分の商品ではなく、他者の価値を売れる形にするプロデューサー的な実践を探す。", "コンテンツホルダーの商品を、ファネルとコピーで売れる形に変換する技術。", "ユニークベネフィット", "自分の商品がなくても、価値ある商品を世に出す側に回れる。"],
  ["北野哲正さん", "AHAコンセプト、講座ビジネス、コンサル型ビジネスの上位設計。", "講座主宰者やコンサルとして独立する前提が早すぎると感じる人。", "主宰者になる前に、現場でファネルを動かす右腕人材として経験を積む道を探す。", "上位設計だけでなく、実際のLP、配信、台本、販売導線まで制作する実践環境。", "アドバンテージ + ユニークベネフィット", "講座を売る人になる前に、講座が売れる構造を作る人になれる。"],
  ["才流（サイル）", "BtoB支援会社としての信頼、メソッド、事例、書籍・メディア、資料DL導線。", "法人向けで堅く、未経験個人が最初の実践体験へ入る導線に見えにくい人。", "BtoBマーケの正攻法を学ぶ前に、小さなファネルで売上導線を体験する道を探す。", "体系化された制作物、チャレンジ導線、セールスレターまでを一気通貫で作る型。", "アドバンテージ", "BtoBの正攻法を学ぶ前に、まず小さなファネルを回してマーケターの感覚を掴む。"],
];
...
const roadmapPhases = [
  ...
  {
    name: "2. リサーチ/コンセプト設計",
    summary: "ターゲット、競合、プロダクトホルダーが提供できる価値を先に調べ、戦わずに選ばれる場所と採用コンセプトを決める。",
    items: [
      {
        name: "事前情報収集",
      ...
      {
        name: "空いている訴求の特定",
        make: "ライバルの強訴求についていけない人を見つけ、その人が探す別手段とプロダクトホルダー価値を接続する。",
        input: "ライバル比較、強訴求、未充足顧客、別手段、プロダクトホルダー価値",
        output: "空きポジション",
        href: "research.html",
      },
      {
        ...
        input: "ターゲット、ライバル、プロダクトホルダー価値、USP判定",
        output: "コンセプトシート",
        href: "concept.html",
      },
      {
...
function competitorPositionCards() {
  return `<div class="concept-sequence">${competitorPositionRows.map(([name, strongAppeal, dropout, alternative, holderValue, usp, appeal], index) => `<article class="concept-item">
<span class="concept-number">${String(index + 1).padStart(2, "0")}</span>
<div>
...
<tr><th>プロダクトホルダー価値</th><td>${esc(holderValue)}</td></tr>
<tr><th>USP判定</th><td>${esc(usp)}</td></tr>
...
${conceptItem(6, "プロダクトホルダーの強み", "Company", "お金をかけないプロダクトローンチ、ファネル全体の設計、起業家やコンテンツホルダーの売上を伸ばしてきた現場経験、ギラギラしないチーム型の土壌。")}
...
${conceptItem(3, "Company", "プロダクトホルダー", "プロダクトローンチ、ファネル設計、累計売上100億円超の実績、全員で勝つ文化、コンテンツホルダーの価値を世の中へ届ける現場経験。")}
</div></section>
...
<section class="panel"><h2>書籍から取り込むリサーチ原則</h2><p class="note">『戦わずして売る技術』からは、競合をプロダクト競合だけで見ず、インサイト競合とメソッド競合まで含めて棲み分けを作る考え方を取り込みます。さらに、プロダクトホルダーの価値がアドバンテージUSPなのか、ユニークベネフィットUSPなのかを判定してから訴求へ変換します。</p><table class="asset-table"><thead><tr><th>原則</th><th>AIに考えさせること</th></tr></thead><tbody>${researchPrincipleRows.map(([label, detail]) => `<tr><td><strong>${esc(label)}</strong></td><td>${esc(detail)}</td></tr>`).join("")}</tbody></table></section>
