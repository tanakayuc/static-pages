...
const coreFunnelRows = [
  ...
  ["Day1〜Day5コンテンツ", "5日間のライブと課題で価値提供と販売前の納得感を作る。", "live-scripts.html"],
...
const challengePatternRows = [
  ...
  { label: "5チャレ", position: "成果型 / 今回採用", range: "Day1〜Day5", next: "Day2 / Day3 / Day4 / Day5", detail: "成果を上げる人に多い形。今回の完成素材サンプルは5チャレで、5日間のライブ、課題、販売接続を作る。" },
];
...
const visibleFunnelNodes = [
  ...
  ["価値提供フェーズのLINEオープンチャット", "参加場所", "固定投稿、通常配信、ライブ案内、課題案内を受け止める。", "line.html", "工程6"],
  ["Day1〜Day5ライブ", "価値提供", "ライブと課題で実践経験と納得感を作る。", "live-scripts.html", "工程7"],
...
const chapterAssetRows = [
  ...
  ["4. コンテンツ設計", "全体カリキュラム、Day別テーマ、コアシナリオ、ワーク案", "live-scripts.html"],
  ...
  ["7. 台本制作", "Day1〜Day5ライブ台本、課題フォーム、アーカイブ導線", "live-scripts.html"],
...
const productionLayerRows = [
  ...
  {
    layer: "価値提供フェーズの素材",
    purpose: "登録後に参加者を迷わせず、ライブと課題で納得感を作る素材群。",
    items: [
...
const productionCategoryRows = [
  ...
  },
  {
    ...
    meta: "Value",
    href: "value.html",
    detail: "Day1着席後からDay5本編まで。価値提供フェーズのLINEオープンチャットとライブ台本を確認します。",
    items: ["価値提供フェーズのLINEオープンチャット", "Day1〜Day5ライブ台本"],
  },
  {
    label: "販売の素材一覧",
    meta: "Sales",
...
const productionFlowRows = [
  ...
  {
    phase: "4. コンテンツ設計",
    purpose: "チャレンジ全体の教育テーマと、各日のゴール、ワークを決める。",
    assets: ["全体カリキュラム", "Day別テーマ", "コアシナリオ", "ワーク案"],
  ...
  {
    phase: "7. 台本制作",
    purpose: "Day1〜Day5のライブで伝える順番、課題、販売前の納得感を作る。",
    assets: ["Day1〜Day5ライブ台本", "課題フォーム", "アーカイブ導線"],
  ...
  {
    phase: "9. 本番運用/改善",
    purpose: "本番前に必要な公開前チェック、納品物、更新履歴を整理する。",
    assets: ["成果物一覧", "原稿/指示書所在", "公開前チェック", "更新履歴"],
...
const roadmapPhases = [
  {
    name: "1. 事前設計",
    summary: "プロモーションを始める前に、出口商品、販売ファネル、販売モデル、KPIを仮決めする。教育グループとライブ日数はターゲット・コンセプト確定後に決める。",
    items: [
      roadmapStep("1", "販売したい商品を決める", "販売する商品、価格、期間、販売本数を仮決めする。", "既存の商品・サービス一覧", "出口商品リスト", "offer.html"),
      roadmapStep("2", "販売ファネルを決める", "今回採用するファネル種別をチャレンジローンチとして仮決めする。", "出口商品・販売条件", "販売ファネル", "visual-report.html"),
      roadmapStep("3", "販売モデルを決める", "WEB直接販売、個別相談、体験セミナー経由、セミナーセールスのどれで販売するかを仮決めする。", "出口商品・価格帯・説明難度", "販売モデル", "visual-report.html"),
      roadmapStep("4", "目標KPIの設定", "仮売上と商品単価から必要成約数、必要申込数、必要リスト数、必要アクセス数を逆算する。", "仮売上・平均単価・販売モデル", "KPI逆算メモ", "visual-report.html"),
    ],
  },
  {
    name: "2. コンセプト設計",
  ...
  {
    name: "4. コンテンツ設計",
    summary: "ターゲットとコンセプトを踏まえて、教育グループ、チャレンジ日数、5日間の内容、課題フォーム、コアストーリー、登録直後の案内素材を決める。",
    items: [
      roadmapStep("5", "教育グループを決める", "ターゲットとコンセプトを踏まえ、参加者をどこに集めるかを決める。", "ターゲットシート・コンセプトシート", "教育グループ方針", "line.html"),
      roadmapStep("6", "チャレンジ日数・ライブ回数を決める", "2チャレ / 3チャレ / 4チャレ / 5チャレのどれで進めるか、ライブ本数を決める。", "ターゲットシート・コンセプトシート・オファー", "チャレンジ日数・ライブ本数", "live-scripts.html"),
      ...
      roadmapStep("19", "チャレンジ課題フォームの整理", "各日の課題と提出フォームの運用メモを整理する。", "コンセプト・ターゲット", "課題フォームメモ"),
  ...
  },
  {
    ...
    items: [
      ...
      roadmapStep("35", "LINEオープンチャット事前案内の整備", "ライブ開始前までに送る事前案内文を作る。", "コンセプト・VSLシナリオ・スケジュール", "事前案内文", "line.html"),
  ...
  },
  {
    ...
    items: [
      ...
      roadmapStep("47", "チャレンジ課題のアウトプットフォーム", "各日の課題提出先を用意する。", "課題内容", "回答フォームURL"),
    ],
  },
  {
    name: "8. プロモ素材の作成",
...
<div class="format-stages">
  ...
  <section class="format-stage">
    ...
    ${challengeDayStrip()}
    <p>Day1〜Day5のライブ台本、配信、課題を素材として管理します。</p>
  </section>
  <section class="format-stage">
...
const fixedNotes = list(`${valueMaterialRoot}/01_LINEオープンチャット/01_固定投稿`)
  ...
  .filter((note) => !/特典/.test(note.title))
...
const plannedSpots = list(`${valueMaterialRoot}/01_LINEオープンチャット/02_通常配信_Day1前〜Day5本編`)
  ...
  .filter((spot) => !/特典/.test(spot.title))
...
function linePageBody() {
  return `<div class="stepmail-content reader-content">
	...
	<table class="asset-table compact-table"><tbody>
	<tr><th>固定投稿</th><td>${fixedNotes.length}件。ライブ参加、課題、基本案内を常設する。</td></tr>
...
<tr><th>価値提供</th><td>Day1〜Day5のライブ、課題、アーカイブを通常配信で案内する。</td></tr>
...
<tr><td>価値提供中</td><td>${phaseCounts["価値提供中"] || 0}件</td><td>ライブ案内、課題提出、復習案内。</td></tr>
</tbody></table>
...
.brand-mark { display: grid; place-items: center; width: 46px; height: 46px; border-radius: 8px; background: var(--main); color: #fff; font-weight: 800; }
.brand-title { margin: 0; font-size: 18px; line-height: 1.35; font-weight: 800; }
.brand-sub { display: block; margin-top: 2px; color: var(--muted); font-size: 12px; font-weight: 650; }
.nav-section { margin: 14px 0 5px; color: var(--muted); font-size: 11px; font-weight: 760; }
.nav-link { display: grid; grid-template-columns: 24px 1fr; gap: 8px; align-items: center; min-height: 34px; padding: 6px 8px; border-radius: 8px; color: var(--ink); font-size: 13px; font-weight: 700; }
...
.nav-num { display: grid; place-items: center; width: 21px; height: 21px; border-radius: 999px; background: var(--soft); color: var(--sub); font-size: 11px; font-weight: 800; }
.back-link {
  display: grid;
...
.status { justify-self: start; padding: 4px 9px; border-radius: 999px; background: var(--soft); color: var(--sub); font-size: 12px; font-weight: 760; white-space: nowrap; }
...
.funnel-map-head span { color: var(--sub); font-size: .78rem; font-weight: 760; }
...
.node-index { display: grid; place-items: center; width: 38px; height: 38px; border-radius: 8px; background: var(--main); color: #fff; font-size: .78rem; font-weight: 760; }
...
.node-meta { color: var(--sub); font-size: .76rem; font-weight: 760; }
...
.format-summary span { color: var(--sub); font-size: .78rem; font-weight: 760; }
...
.stage-head span { color: var(--sub); font-size: .76rem; font-weight: 760; }
.stage-head strong { color: var(--ink); font-size: 1.02rem; line-height: 1.45; }
.traffic-row { display: flex; flex-wrap: wrap; gap: 7px; }
.traffic-row span { display: inline-flex; align-items: center; min-height: 26px; padding: 3px 9px; border-radius: 999px; background: var(--soft); color: var(--sub); font-size: 12px; font-weight: 760; }
.format-chain { display: grid; gap: 8px; }
.format-node { position: relative; display: grid; gap: 2px; padding: 10px 12px; border: 1px solid var(--line); border-radius: 8px; background: var(--pale); color: var(--ink); text-decoration: none; font-weight: 700; }
.format-node::after { content: "↓"; position: absolute; left: 50%; bottom: -18px; transform: translateX(-50%); color: var(--sub); font-size: 13px; font-weight: 760; }
...
.day-chip { display: grid; place-items: center; min-height: 46px; padding: 6px 4px; border: 1px solid var(--line); border-radius: 8px; background: var(--pale); color: var(--ink); font-size: 13px; font-weight: 700; text-align: center; }
...
.jump-nav a { display: inline-flex; align-items: center; min-height: 36px; padding: 7px 12px; border: 1px solid var(--line); border-radius: 8px; background: #fff; color: #2d6f61; font-size: 14px; font-weight: 700; text-decoration: none; }
...
.asset-table th { background: linear-gradient(180deg, var(--main), var(--sub)); color: #fff; font-size: .86rem; font-weight: 700; border-top: 0; }
...
.stepmail-side h3 { margin: 0 0 .8rem; color: #243b36; font-size: .96rem; font-weight: 700; }
.stepmail-side-section { margin: 1.15rem 0 .35rem; color: var(--sub); font-size: .68rem; font-weight: 680; letter-spacing: .03em; }
.stepmail-side-link { display: block; padding: .5rem .5rem; border-radius: 8px; color: #243b36; font-size: .76rem; line-height: 1.5; font-weight: 650; }
.stepmail-side-link:hover,
.stepmail-side-link.active { background: var(--soft); color: var(--sub); text-decoration: none; }
.stepmail-side-link .date { display: block; color: var(--muted); font-size: .62rem; line-height: 1.35; font-weight: 600; }
...
.reader-page .stepmail-content.reader-content {
  padding: 2.65rem 3rem 3.15rem;
  border: 1px solid var(--line);
  border-radius: 18px;
  background: var(--paper);
  box-shadow: 0 8px 30px rgba(24, 155, 125, .06);
}
.reader-page .stepmail-content.reader-content .stepmail-block:last-child {
  padding-bottom: 0;
  border-bottom: 0;
}
...
.block-label { margin: 0 0 .45rem; color: var(--sub); font-size: .78rem; font-weight: 760; letter-spacing: .02em; }
...
.mail-entry { padding: 1.18rem 0; border-bottom: 1px dashed var(--line); }
.reader-page .mail-entry { padding: 1.62rem 0; }
...
.mail-number { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 8px; background: var(--soft); color: var(--sub); font-size: .76rem; font-weight: 700; }
.mail-entry h3 { margin: 0; color: #243b36; font-size: .98rem; font-weight: 700; line-height: 1.55; }
...
.script-block .time { display: inline-flex; margin-bottom: 7px; padding: 3px 8px; border-radius: 999px; background: var(--soft); color: var(--sub); font-size: 12px; font-weight: 760; }
.funnel { display: grid; grid-template-columns: 1fr; gap: 0; }
.funnel-step { padding: .8rem 0 .8rem 1rem; border: 0; border-left: 4px solid var(--line); background: transparent; text-align: left; font-weight: 700; }
details { border: 1px solid var(--line); border-radius: 8px; background: #fff; overflow: hidden; }
details + details { margin-top: 10px; }
summary { cursor: pointer; padding: 14px 16px; color: var(--ink); font-weight: 700; }
...
.article-panel { padding: 3rem 3.2rem 3.4rem; box-shadow: 0 8px 30px rgba(24, 155, 125, .06); }
...
.article strong { color: var(--sub); font-weight: 700; }
...
@media (max-width: 900px) {
  ...
  .reader-page .stepmail-content.reader-content { padding: 1.55rem 1.25rem 1.85rem; border-radius: 14px; }
...
<section class="panel"><h2>見込み客が見る導線</h2>${visibleFunnelMap([
  ...
  ["Day1〜Day5", "価値提供", "ライブ台本 / 課題", "live-scripts.html", "価値提供"],
...
<tr><td>集客</td><td>オプトインLP原稿、LPヘッドデザイン指示書、オプト前VSL台本、オプトイン後メルマガ、サンキューページ原稿、紹介用文章、集客前メッセージ</td><td><a href="lp.html">集客素材</a></td></tr>
	<tr><td>価値提供</td><td>Day1〜Day5台本、課題、価値提供フェーズのLINEオープンチャット（固定投稿/通常配信）</td><td><a href="value.html">価値提供素材</a></td></tr>
...
pages.set("target.html", page({
  ...
  body: `<section class="panel"><h2>ターゲット正式版</h2><div class="concept-sequence">
${conceptItem(1, "見込み客像", "Customer", "起業スクールやSNS発信型の講座で「自分の商品を作って売る」道に挑戦したものの、自分の商品構築やカリスマ的な発信に自信を持てなかった会社員・副業希望者。前に出るよりも、誰かの価値を整理し、売れる導線を支える側に適性がある。")}
${conceptItem(2, "過去に買っていそうな商品/講座", "History", "起業スクール、商品構築講座、SNS発信講座、コンテンツホルダー型の高単価講座、Web制作・デザイン・ライティングなどの単体スキル講座。どれも学んだが、自分を商品化することや発信で前に出ることに違和感が残っている。")}
${conceptItem(3, "本当の資質", "Strength", "真面目さ、継続力、支援力、客観視、メタ認知、数字を見る力。キャラクターの濃さではなく、キャラクターの薄さ、一歩引いて全体を見られること、暴走するコンテンツホルダーを支えられることが武器になる。")}
</div></section>
<section class="panel"><h2>悩みと勘違い</h2><div class="concept-sequence">
${conceptItem(1, "業界への不信感トップ3", "Distrust", "「誰でも商品を作れる」と言われたが、自分には無理だった。他の人のようにカリスマ的に前へ出られない。裏方として活動しても、結局は安く買い叩かれてしまう。")}
${conceptItem(2, "信じていることトップ3", "Belief", "自分には売れる知識・経験・実績がない。クライアントワークをしても安売りになってしまう。起業の世界では、カリスマ性、人脈、実績、強い発信力がなければ食っていけない。")}
${conceptItem(3, "真の原因", "Cause", "本人の努力不足ではなく、市場が「自分の商品を作って表に立つ道」と「安い単体スキルを売る道」に偏りすぎていること。器用貧乏な人が、高単価で報われる裏方マーケターのポジションをまだ知らない。")}
</div></section>
<section class="panel"><h2>動く条件</h2><ol><li>「商品を持つ側」ではなく「商品を広げる側」でも高単価で報われると分かる。</li><li>地味で平凡、顔出しが苦手、メタ認知が強いことが、裏方Webマーケターの適性になり得ると分かる。</li><li>コンテンツホルダーになれなかった人にも、コンテンツホルダーを支える別ルートがあると分かる。</li><li>デザインやコピーなどの単体スキルではなく、売上導線全体に関わることで安売りから抜けられると分かる。</li><li>45日間の実践環境で、チーム、成果報酬、プロモーション支援の職種的ポジションを体験できると分かる。</li></ol></section>
<section class="panel"><h2>旧世界 / 新世界</h2><div class="concept-sequence">
${conceptItem(1, "旧世界", "Before", "自分の知識・才能・経験を商品化し、SNSで発信し、前に出る人だけが高単価で報われる。裏方は単体作業を安く請けるしかない。")}
${conceptItem(2, "新世界", "After", "前に出る人を支える裏方Webマーケターとして、プロモーション全体に関わり、コンテンツホルダーの売上を作る側に回る。器用貧乏が、売上責任を持てる高単価ポジションに変わる。")}
</div></section>
...
${conceptItem(1, "1. ポジショニング分析", "Positioning", "ターゲット、ライバル、自社の状況を踏まえ、「空きポジションはどこか」を先に提案する。ここではコンセプトを決め切らず、狙えそうな方向性を比較する。")}
${conceptItem(2, "2. コンセプトネタ集め", "Materials", "採用するポジションに対して、ターゲット、ノウハウ、ベネフィット、キーワード、権威性、無料オファーを集める。")}
${conceptItem(3, "3. コンセプトの策定", "Concept", "集めたネタを合体させ、LPのファーストビューで一瞬で伝わるコンセプトにする。")}
${conceptItem(4, "4. コアシナリオ", "Scenario", "完成したコンセプトから、勘違い、真の原因、旧世界/新世界、解決策へ展開する。")}
</div></section>
<section class="panel"><h2>1. ポジショニング分析</h2><p class="note">リサーチの結論をそのままコンセプトにするのではなく、まず「どの空きポジションを狙うか」の候補を出す。</p><div class="concept-sequence">
${conceptItem(1, "Customer", "ターゲット", "起業スクールやSNS発信型の講座で、自分の商品化や派手な発信に自信を持てなかった会社員・副業希望者。真面目さ、継続力、支援力、客観視、メタ認知、数字を見る力はあるが、前に出るスター型の道には違和感がある。")}
${conceptItem(2, "Competitor", "ライバル", "SNS起業、副業スクール、Web制作スクール、広告運用講座、AI副業系。多くは個人が目立つこと、単体スキルを身につけること、自分の商品を売ることに寄りやすい。")}
${conceptItem(3, "Company", "自社の強み", "プロダクトローンチ、ファネル設計、LP、配信、台本、セールスレターまで一気通貫で作る力。コンテンツホルダー支援、累計売上100億円超の実績、ギラギラしないチーム型の土壌を持つ。")}
${conceptItem(4, "空きポジション案A", "案", "裏方Webマーケター。自分がスターになるのではなく、社長・コンテンツホルダーの右腕としてプロモーション全体を支え、売上に関わる。今回の採用案。")}
${conceptItem(5, "空きポジション案B", "案", "顔出し不要のプロモーション実践者。顔出しやSNS発信が苦手な人でも、売れる導線の裏側を理解して実践できる立ち位置。")}
${conceptItem(6, "空きポジション案C", "案", "単体スキルではなくファネル全体を見られる支援者。デザイン、広告、ライティングの作業者ではなく、集客から販売までの構造を見て動ける人材になる。")}
${conceptItem(7, "採用する方向性", "Decision", "今回は案Aを主軸にする。理由は、ターゲットの「前に出たくない」「自分の商品がない」「でも売上に関わりたい」という悩みと、自社のプロモーション設計力が最も自然につながるため。")}
</div></section>
<section class="panel"><h2>2. コンセプトネタ集め</h2><p class="note">以前は「ゲーム」として仮決めしていた要素を、採用ポジションに合わせて確定させる。ここではまだ文章を整え切らず、使う素材を集約する。</p><div class="concept-sequence">
${conceptItem(1, "ターゲット", "Target", "地味で平凡な会社員向け。顔出し、才能、経験、自分の商品がないことで、起業スクールやSNS発信型の道に乗り切れなかった人。")}
${conceptItem(2, "入口の否定解除", "Hook", "才能・経験・顔出し不要。自分がスターにならなくても、売上に関わる道があると最初に伝える。")}
${conceptItem(3, "ノウハウ1", "Know-how", "「裏方」起業へのロードマップ。表に立つ起業ではなく、裏方で売上導線を支える進み方を見せる。")}
${conceptItem(4, "ノウハウ2", "Know-how", "プロモーション戦略を担う方法。LP、配信、台本、セールスレターまで、売れる仕組み全体を理解する。")}
${conceptItem(5, "ベネフィット", "Benefit", "希少価値の高い“社長の右腕”になる。単体作業者ではなく、売上に近いポジションへ進む未来を提示する。")}
${conceptItem(6, "キーワード", "Keyword", "Webマーケターへの道。職種型の言葉で、悩み解決だけではなく新しい働き方への憧れを作る。")}
${conceptItem(7, "無料オファー", "Free offer", "無料5日間 Liveトレーニングプログラム。無料参加で、裏方Webマーケターという新しい選択肢を体験できる形にする。")}
${conceptItem(8, "権威性/差別化", "Authority", "10億円規模のマーケッターが直接教える。単なる副業講座ではなく、プロモーション戦略を現場で見てきた人から学べることを差別化要素にする。")}
</div></section>
<section class="panel"><h2>3. コンセプトの策定</h2><p class="note">集めたネタを、LPや台本でそのまま使える見せ方に合体させる。</p><div class="concept-sequence">
${conceptItem(1, "合体後のコンセプト", "Concept", "才能・経験・顔出し不要。地味で平凡な会社員向けに、10億円規模のマーケッターが直接教える、プロモーション戦略を担う希少価値の高い“社長の右腕”になるための「裏方」起業ロードマップを公開する無料5日間Liveトレーニングプログラム。")}
${conceptItem(2, "LPファーストビュー案", "FV", "才能・経験・顔出し不要！<br>地味で平凡な会社員向け<br>Webマーケターへの道<br>無料5日間 Liveトレーニングプログラム<br><br>10億円規模のマーケッターが直接教える、プロモーション戦略を担う希少価値の高い“社長の右腕”になる方法。<br>「裏方」起業へのロードマップを公開。")}
${conceptItem(3, "成立理由", "Logic", "ターゲットは、地味で平凡な会社員。ノウハウは、裏方起業ロードマップとプロモーション戦略。ベネフィットは、希少価値の高い社長の右腕になること。キーワードは、Webマーケターへの道。権威性は、10億円規模のマーケッターが直接教えること。")}
${conceptItem(4, "商品接続", "Bridge", "無料5日間Liveトレーニングで考え方を体験し、より実践したい人を45日間WEBマーケター超実践ブートキャンプへ接続する。")}
</div></section>
<section class="panel"><h2>4. コアシナリオ</h2><p class="note">コンセプトで引きつけた後、ライブ・LP・販売ページで伝える教育の骨格。勘違い、真の原因、旧世界/新世界、解決策はここに集約する。</p><div class="concept-sequence">
${conceptItem(1, "勘違い", "Misbelief", "稼ぐには自分が有名になる必要がある。自分の商品がないと始められない。単体スキルを積み上げれば自然に売上につながる。実績がない人はプロモーションに関われない。")}
${conceptItem(2, "真の原因", "Cause", "努力不足やセンス不足ではなく、売上までの全体構造を見通す型と、最初の実績を安全に作れる実践環境がないこと。")}
${conceptItem(3, "旧世界", "Before", "自分がスターになり、SNSで目立ち、自分の商品やフォロワーを持たなければ始められない。単体スキルを積み上げても、売上までの全体構造が見えない。")}
${conceptItem(4, "新世界/ベネフィット", "After", "社長の右腕として、裏方でプロモーションを支えながら売上に関われる。顔出しや自分の商品を前提にせず、ファネル全体を理解して実績を作れる。")}
${conceptItem(5, "解決策", "Solution", "D.E.C.O.D.E.で集客、教育、販売、オファー、LTVを構造として理解し、裏方Webマーケターとしてプロモーション全体に関わる実践環境へ進む。")}
${conceptItem(6, "コアシナリオ本文", "Scenario", "顔出しや商品作りに詰まる会社員に、裏方Webマーケターという空きポジションを提示し、5日間で売上構造を理解させ、45日間の実践環境で最初の経験作りへ進める。")}
</div></section>
`}));
...
pages.set("research.html", page({
  ...
  title: "リサーチシート",
  eyebrow: "設計シート",
  lead: "ライバルの強訴求と取りこぼしから、今回どのポジションを狙うべきかを整理します。",
  body: `<section class="panel"><h2>リサーチの流れ</h2><ol><li>ライバルが何を強く訴求しているかを見る。</li><li>その訴求に魅力を感じつつ、ついていけない人を探す。</li><li>ターゲット、ライバル、自社の強みを3Cで並べる。</li><li>「ここが空いているのではないか」というポジションを決める。</li><li>その結果として、今回どんな案件にするべきかを判断する。</li></ol></section>
<section class="panel"><h2>同業ライバルリサーチ</h2>${competitorResearchTable()}</section>
<section class="panel"><h2>ライバルの強訴求と取りこぼし</h2>${competitorPositionCards()}</section>
<section class="panel"><h2>ポジショニングとしての3C分析</h2><div class="concept-sequence">
...
${conceptItem(2, "Competitor", "競合", "ライバルは、自分らしい経営、SNS動画、コンテンツ販売、魂の差別化、講座ビジネス化、BtoBメソッドなどを強く訴求している。強い一方で、顔出し、自分の商品、カリスマ性、講座主宰者化、法人向けの堅さについていけない人が残る。")}
${conceptItem(3, "Company", "自社", "プロダクトローンチ、ファネル設計、LP、配信、台本、セールスレターまで一気通貫で作る力、コンテンツホルダー支援、全員で勝つ文化、実践環境を持つ。")}
${conceptItem(4, "Gap", "空いている場所", "スター型起業でも単体スキル習得でもなく、社長・コンテンツホルダーの右腕としてプロモーション全体を裏方から支え、売上に関わる実績を作るポジション。")}
</div></section>
<section class="panel"><h2>リサーチ結論</h2><p class="quote">今回の案件は、本命商品であるPLCそのものではなく、会社員・副業希望者が「自分がスターにならなくても売上に関われる」と理解できるダウンセル商品として設計する。題材は「WEBマーケターへの道」とし、45日間の実践環境へ進む前段階で、裏方Webマーケターという職種的ポジションを提示する。</p></section>
<section class="panel"><h2>コンセプトシートへ渡す判断</h2><table class="asset-table"><tbody>
<tr><th>採用する立ち位置</th><td>社長・コンテンツホルダーの右腕として、プロモーション全体を支える裏方Webマーケター。</td></tr>
<tr><th>コンセプト化する論点</th><td>地味で平凡、顔出しが苦手、自分の商品がないことを弱みではなく適性として捉え直す。</td></tr>
<tr><th>コアシナリオへの接続</th><td>旧世界はスター型起業。新世界は、売上導線を支える裏方Webマーケターとして実践環境に入ること。</td></tr>
</tbody></table></section>`}));
...
pages.set("value.html", page({
  ...
  title: "価値提供の素材一覧",
  eyebrow: "制作物",
  lead: "価値提供フェーズのLINEオープンチャットとDay1〜Day5ライブ台本をまとめて確認します。",
  body: `${funnelSpotlightCard({
  title: "価値提供素材の対象箇所",
