...
pages.set("sheets.html", page({
 ...
 ${conceptItem(5, "オファーシート", "Offer", "商品コンセプト、変化の約束、なぜ可能か、商品名、サポート期間、商品形態、サービス内容、サポート体制、特典、保証を整理する。")}
...
pages.set("offer.html", page({
  ...
  title: "オファーシート",
  eyebrow: "設計シート",
  lead: "第3章では、後工程で詳細化できるように、本命商品の約束、形態、サポート、特典、保証を整理します。",
  body: `<section class="panel"><h2>オファー設計の確認項目</h2><div class="concept-sequence">
${conceptItem(1, "商品コンセプト", "Concept", "地味で平凡な会社員が、社長の右腕としてプロモーションを支えるWebマーケターになるための実践環境。")}
${conceptItem(2, "誰に対して、どんな変化を約束する商品か", "Promise", "顔出し、自分の商品、強い実績がない会社員に、売上導線を理解し、裏方Webマーケターとして最初の経験作りへ進む変化を約束する。")}
${conceptItem(3, "なぜその変化が可能か", "Reason", "D.E.C.O.D.E.で売上構造を分解し、知識だけで終わらせず、45日間の実践環境、伴走、チーム、課題を通じて行動に接続するから。")}
${conceptItem(4, "商品名", "Name", "45日間WEBマーケター超実践ブートキャンプ。")}
${conceptItem(5, "サポート期間", "Term", "45日間。短期集中で理解から実践へ進む前提で設計する。")}
${conceptItem(6, "商品形態", "Format", "オンライン講座、実践課題、コミュニティ/チーム型サポート、質問回答、ライブまたは録画コンテンツを組み合わせる。")}
${conceptItem(7, "サービス内容", "Service", "売上構造の理解、プロモーション設計、クライアント獲得/関わり方、課題提出、アウトプット、販売導線理解を扱う。")}
${conceptItem(8, "サポート体制", "Support", "質問できる場、課題へのフィードバック、チームで進める空気、必要に応じた追加解説で、ひとりで止まらない状態を作る。")}
${conceptItem(9, "特典", "Bonus", "課題提出特典、復習資料、実践用テンプレート、コンプリート特典など、行動を進めるための補助素材。")}
${conceptItem(10, "保証", "Guarantee", "正式条件は確認が必要。保証を入れる場合は、行動条件、対象範囲、期限を明確にする。")}
</div></section>
...
<section class="panel"><h2>正式確認が必要な項目</h2><ul><li>正式価格</li><li>支払い方法</li><li>分割払いの有無</li><li>サポート体制の詳細</li><li>保証条件</li><li>PLC差額参加の正式条件</li></ul></section>`}));
