...
${conceptItem(2, "ターゲット正式版", "Customer", "起業スクールやコンテンツホルダー型の講座で、自分の商品化や派手な発信に自信を持てなかった会社員・副業希望者。", ["前に出るカリスマではなく、コンテンツホルダーを支える裏方Webマーケターとして高単価で報われる道を探している。", "真面目さ、継続力、支援力、客観視、メタ認知、数字を見る力を持っている。"])}
...
<section class="panel"><h2>わしづかみコンセプト設計</h2><p class="note">コンセプトは単なるキーワードではなく、ターゲット、ノウハウ、ベネフィット、キーワード、権威性、無料オファーを組み合わせて、LPのファーストビューで一瞬で伝わる企画にする。</p><div class="concept-sequence">
...
${conceptItem(9, "合体後のLPコンセプト", "Concept", "才能・経験・顔出し不要。地味で平凡な会社員向けに、10億円規模のマーケッターが直接教える、プロモーション戦略を担う希少価値の高い“社長の右腕”になるための「裏方」起業ロードマップを公開する無料5日間Liveトレーニングプログラム。")}
</div></section>
<section class="panel"><h2>LPファーストビューへの反映</h2><p class="quote">才能・経験・顔出し不要！<br>地味で平凡な会社員向け<br>Webマーケターへの道<br>無料5日間 Liveトレーニングプログラム<br><br>10億円規模のマーケッターが直接教える、プロモーション戦略を担う希少価値の高い“社長の右腕”になる方法。<br>「裏方」起業へのロードマップを公開。</p><div class="concept-sequence">
${conceptItem(1, "なぜ成立するか", "Logic", "ターゲットは、地味で平凡な会社員。ノウハウは、裏方起業ロードマップとプロモーション戦略。ベネフィットは、希少価値の高い社長の右腕になること。キーワードは、Webマーケターへの道。権威性は、10億円規模のマーケッターが直接教えること。")}
${conceptItem(2, "商品接続", "Bridge", "無料5日間Liveトレーニングで考え方を体験し、より実践したい人を45日間WEBマーケター超実践ブートキャンプへ接続する。")}
</div></section>
